...
$conn=mysqli_connect("localhost","root","","project");
 ...
 <!doctype html>
	 ...
	 <div class="notice_modifybox">
		 <form action="notice_modify_ok.php/<?php echo $notice['idx']; ?>" method="post">
		 <table class="table table-striped table-bordered">
			 <thead class="thead-dark">
				 ...
				 <tbody>
					 ...
					 <tr>
						 <td colspan="4" height="400"><textarea name="content" id="ucontent" rows="20" cols="180"><?php echo $notice['content']; ?></textarea></td>
					 </tr>
				 </tbody>
				 </table>
